...
<body>
 <%
      ...
      <nav class="navbar navbar-expand-lg bg-light shadow-lg " >
        ...
        <div class="mt-2 d-flex justify-content-end  w-75" style="margin-left: 14%;">
          ...
          <div class="container-fluid bg-white content " style=" width:fit-content; ">
        	 <div class="col mt-4 mb-4 shadow-sm bg-light border border-1 p-2  " style=" border-radius: 10px;">
	...
	if(${approvealert}==true){
    	swal("Success", "Leave is approved ", "success");
    }
	if(${rejectalert}==true){
    	swal("Success", "Leave is rejected ", "success");
    }
      </script> 
