        ...
        <div class="d-flex">
         ...
         <div class="mt-4" style="float:left;">
            ...
            <div class="container-fluid bg-white content" style=" width:fit-content;">
                    ...
                    <form action="addadmin" class="row g-3 "  name="addForm" style="padding: 20px;" onsubmit="return formValidate()">
                        <h1 align="center" class="fs-3 fw-bold" style="color: #8424BC" >Add Admin</h1>
                          <div class="col-md-12">
